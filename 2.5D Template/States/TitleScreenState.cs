...
class TitleScreenState : GameObjectLibrary
{
    ...
    public TitleScreenState()
    {
        ...
        editorButton.Position = new Vector2((GameEnvironment.Screen.X - startButton.Width) / 16 * 13, (GameEnvironment.Screen.Y - startButton.Height) / 2);
        ...
        exitButton.Position = new Vector2((GameEnvironment.Screen.X - exitButton.Width) / 16 * 13, (GameEnvironment.Screen.Y - exitButton.Height) / 4 * 3);
